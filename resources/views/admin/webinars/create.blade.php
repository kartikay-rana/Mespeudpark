                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                ...
                                                <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                                                    ...
                                                    <option value="study" @if((!empty($webinar) and $webinar->isStudy()) or old('type') == \App\Models\Webinar::$study) selected @endif>{{'Study' }}</option>
                                                    <option value="test" @if((!empty($webinar) and $webinar->isTest()) or old('type') == \App\Models\Webinar::$test) selected @endif>{{'Test' }}</option>
                                                    <option value="crashcourse" @if((!empty($webinar) and $webinar->isCrashcourse()) or old('type') == \App\Models\Webinar::$crashcourse) selected @endif>{{'Crash Course' }}</option>
                                                    <option value="recorded" @if((!empty($webinar) and $webinar->isRecorded()) or old('type') == \App\Models\Webinar::$recorded) selected @endif>{{'Recorded Lectures' }}</option>
                                                    <option value="previousyearpaper" @if((!empty($webinar) and $webinar->isPreviousyearpaper()) or old('type') == \App\Models\Webinar::$previousyearpaper) selected @endif>{{'Previous year paper' }}</option>
                                                    <option value="currentaffairs" @if((!empty($webinar) and $webinar->isCurrentaffairs()) or old('type') == \App\Models\Webinar::$currentaffairs) selected @endif>{{'Current Affairs' }}</option>
                                                    <option value="one_liner" @if((!empty($webinar) and $webinar->isOne_liner()) or old('type') == \App\Models\Webinar::$one_liner) selected @endif>{{'One Line' }}</option>
                                                    <option value="job_alert_upcoming" @if((!empty($webinar) and $webinar->isJob_alert_upcoming()) or old('type') == \App\Models\Webinar::$job_alert_upcoming) selected @endif>{{'Job alert upcoming' }}</option>
                                                    <option value="job_alert_latest" @if((!empty($webinar) and $webinar->isJob_alert_latest()) or old('type') == \App\Models\Webinar::$job_alert_latest) selected @endif>{{'job alert latest' }}</option>
                                                    <option value="legal_updates" @if((!empty($webinar) and $webinar->isLegal_updates()) or old('type') == \App\Models\Webinar::$legal_updates) selected @endif>{{'Legal Update' }}</option>
                                                    <option value="section_time_test" @if((!empty($webinar) and $webinar->isSection_time_test()) or old('type') == \App\Models\Webinar::$section_time_test) selected @endif>{{'Section time set' }}</option>
                                                </select>
