                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('cat_id') is-invalid @enderror" name="cat_id">
                                                <option {{ !empty($trend) ? '' : 'selected' }} disabled>Choose Main Category</option>

                                                @foreach($maincategories as $category)
                                                    <option value="{{ $category->id }}" {{ (((!empty($post) and $post->cat_id == $category->id) or (old('cat_id') == $category->id)) ? 'selected="selected"' : '') }}>{{ $category->title }}</option>
                                                @endforeach
                                            </select>
