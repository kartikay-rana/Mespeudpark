<div data-action="<?php echo e(!empty($quiz) ? '/admin/quizzes/'. $quiz->id .'/update' : '/admin/quizzes/store'); ?>" enctype="multipart/form-data" class="js-content-form quiz-form webinar-form">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label class="input-label">Quiz Type <span class="text-muted">(Optional)</span></label>
                    
                    <select class="form-control" name="q_type">


                        <option value="<?php echo e('null'); ?>" <?php echo e((!empty($quiz) and $quiz->q_type == '') ? 'selected' : ''); ?>>Null</option>
                        <option value="<?php echo e('c_a_q'); ?>" <?php echo e((!empty($quiz) and $quiz->q_type == 'c_a_q') ? 'selected' : ''); ?>>Current affair Question</option>
                        <option value="<?php echo e('p_y_q'); ?>" <?php echo e((!empty($quiz) and $quiz->q_type == 'p_y_q') ? 'selected' : ''); ?>>Priveris Year Question</option>
                        <option value="<?php echo e('section'); ?>" <?php echo e((!empty($quiz) and $quiz->q_type == 'section') ? 'selected' : ''); ?>>Section time set</option>
                    </select>
                    <?php $__errorArgs = ['q_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label class="input-label"><?php echo e('Negative Mark'); ?></label>
                    <input type="number" value="<?php echo e(!empty($quiz) ? $quiz->negative_mark : old('negative_mark')); ?>" name="ajax[negative_mark]" class="form-control <?php $__errorArgs = ['negative_mark'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
    ...
    <?php if(!empty($quiz)): ?>
        <section class="mt-5">
            <div class="d-flex justify-content-between align-items-center pb-20">
                ...
                <a href="<?php echo e(route('quizImport',$quiz->id)); ?>"><button type="button" class="btn btn-primary btn-sm ml-2 mt-3" >
                  Question Import
                </button></a>
...
<?php if(!empty($quiz)): ?>
     <?php echo $__env->make('admin.quizzes.modals.import_question', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/admin/quizzes/create_quiz_form.blade.php ENDPATH**/ ?>