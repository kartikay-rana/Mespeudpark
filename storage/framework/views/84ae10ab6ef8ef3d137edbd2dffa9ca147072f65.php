<div class="dropdown">
    <button type="button" class="btn btn-transparent dropdown-toggle" <?php echo e((empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : ''); ?> id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i data-feather="bell" width="20" height="20" class="mr-10"></i><span>Notification</span>
...
<?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>