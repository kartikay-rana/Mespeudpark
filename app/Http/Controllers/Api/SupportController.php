...
class SupportController extends Controller
{
    ...
    public function tickets(Request $request, $id = null)
    {
        ...
        return response(['statusCode' => 200, 'message' => "ticket_conversations data",'data'=>$data]);
    ...
    public function store(Request $request)
    {
        ...
        return response(['statusCode' => 200, 'message' => "inser successfully",'data'=>$url]);
    ...
    public function storeConversations(Request $request, $id)
    {
        ...
        return response(['statusCode' => 200, 'message' => "inser successfully"]);
    }
