...
class Webinar extends Model implements TranslatableContract
{
    ...
    static $test = 'test';
    static $study = 'study';
    static $crashcourse = 'crashcourse';
    static $recorded = 'recorded';
    static $one_liner = 'one_liner';
    static $job_alert_upcoming = 'job_alert_upcoming';
    static $job_alert_latest = 'job_alert_latest';
    static $legal_updates = 'legal_updates';
    static $section_time_test = 'section_time_test';
    static $previousyearpaper = 'previousyearpaper';
    static $currentaffairs = 'currentaffairs';
    ...
    public function isCrashcourse()
    {
        return ($this->type == 'crashcourse');
    }
    public function isRecorded()
    {
        return ($this->type == 'recorded');
    }
    public function isPreviousyearpaper()
    {
        return ($this->type == 'previousyearpaper');
    }
    public function isCurrentaffairs()
    {
        return ($this->type == 'currentaffairs');
    }
    public function isOne_liner()
    {
        return ($this->type == 'one_liner');
    }
    public function isJob_alert_upcoming()
    {
        return ($this->type == 'job_alert_upcoming');
    }
    public function isJob_alert_latest()
    {
        return ($this->type == 'job_alert_latest');
    }
    public function isLegal_updates()
    {
        return ($this->type == 'legal_updates');
    }
    public function isSection_time_test()
    {
        return ($this->type == 'section_time_test');
    }
