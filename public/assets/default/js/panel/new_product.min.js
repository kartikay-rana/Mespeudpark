    ...
    38: function (e, t) {
        ...
        !(function (e) {
            ...
            function o(t) {
                ...
                r &&
                    r.length &&
                    (r.select2({ placeholder: e(this).data("placeholder") }),
                    r.on("change", function (t) {
                        ...
                        !(function (t, r) {
                            e.get(
                                ...
                                function (r) {
                                    if (r) {
                                        var a = r.specification,
                                            o = r.multiValues,
                                            l = t.find(
                                                ".js-multi-values-input"
                                            ),
                                            s = t.find(".js-summery-input"),
                                            c = t.find(
                        ...
                        })(e(t.target).closest(".specification-form"), r);
                    }));
            }
            function i(t) {
                var n = e("." + t);
            ...
            function l(t) {
                if (jQuery().tagsinput) {
                    ...
                    n.tagsinput({
                        ...
                        maxTags: n.data("max-tag") ? n.data("max-tag") : 10,
                    });
                }
            }
            e("#summernote").length &&
                ...
                e("body").on("click", ".add-btn", function (n) {
                    ...
                    if (e(".product-images-input-group").length < 4) {
                        var a = feather.icons.x.toSvg({
                                width: 18,
                                height: 18,
                            }),
                            o = r.clone();
                        o.removeClass("main-row"), o.removeClass("d-none");
                        var i = o.find(".add-btn");
                        i &&
                            i
                        ...
                        (l = (l = (l = l.replaceAll("record", t())).replaceAll(
                            "btn-primary",
                            "btn-danger"
                        )).replaceAll("add-btn", "remove-btn")),
                            o.html(l),
                            e("#productImagesInputs").append(o);
                ...
                e("body").on("click", "#productAddFile", function (n) {
                    n.preventDefault();
                    var r = t(),
                        a = e("#newFileForm").html();
                    (a = a.replaceAll("record", r)),
                        e("#filesAccordion").prepend(a),
                        feather.replace();
                }),
                e("body").on("click", ".js-save-file", function (t) {
                    t.preventDefault();
                    var n = e(this);
                    r(n.closest(".file-form"), n);
                }),
                e("body").on("click", ".js-save-specification", function (t) {
                    t.preventDefault();
                    var n = e(this);
                    r(n.closest(".specification-form"), n);
                }),
                e("body").on("click", ".js-save-faq", function (t) {
                    t.preventDefault();
                    var n = e(this);
                    r(n.closest(".faq-form"), n);
                }),
                e("body").on("change", "#categories", function (t) {
                    t.preventDefault();
                    var n = this.value;
                    e.get(
                        "/panel/store/products/filters/get-by-category-id/" + n,
                        function (t) {
                            if (t && void 0 !== t.filters && t.filters.length) {
                                ...
                                e("#categoriesFiltersContainer").addClass(
                                    "d-none"
                                ),
                ...
                e(document).ready(function () {
                    i("select-multi-values-select2");
                }),
                o("search-specification-select2"),
                ...
                e("body").on("click", "#productAddSpecification", function (n) {
                    n.preventDefault();
                    var r = t(),
                        a = e("#newSpecificationForm").html();
                    (a = (a = (a = (a = a.replaceAll("record", r)).replaceAll(
                        "specification-select2",
                        "search-specification-select2-" + r
                    )).replaceAll(
                        "multi_values-select",
                        "multi_values-select2"
                    )).replaceAll("input_tags", "input_tags-" + r)),
                        e("#specificationsAccordion").prepend(a),
                        l("input_tags-" + r),
                        o("search-specification-select2-" + r);
                }),
                ...
                e("body").on(
                    ...
                    function (n) {
                        n.preventDefault();
                        var r = e(this),
                            a = e(this).closest(".js-content-form"),
                            o = r.val(),
                            i = r.attr("data-product-id"),
                            s = r.attr("data-id"),
                            c = r.attr("data-relation"),
                            d = r.attr("data-fields");
                        (d = d.split(",")), r.addClass("loadingbar gray");
                        var u =
                                "/panel/store/products/" +
                                i +
                                "/getContentItemByLocale",
                            f = { item_id: s, locale: o, relation: c };
                        e.post(u, f, function (n) {
                            if (n && n.item) {
                                ...
                                Object.keys(o).forEach(function (n) {
                                    ...
                                    if (-1 !== e.inArray(n, d)) {
                                        var i = n;
                                        "selectedSpecifications" === c &&
                                            ((i = "tags"),
                                            "textarea" === o.type &&
                                                (i = "summary"));
                                        var s = a.find(".js-ajax-" + i);
                                        if (
                                            ("tags" === i &&
                                                s.tagsinput("destroy"),
                                            s.val(r),
