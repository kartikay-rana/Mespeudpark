...
class CartManagerController extends Controller
{
    ...
    { //dd()
        ...
        $check=    Cart::where([
          ...
          $add_course_in_cart=    new Cart();
          $add_course_in_cart->creator_id=$user->id;
          $add_course_in_cart->webinar_id=$webinar_id;
          $add_course_in_cart->created_at=time();
          $add_course_in_cart->save();
    ...
    public function store(Request $request)
    {
      ...
      //  return back()->with(['toast' => $toastData]);
         ...
         return response(['statusCode' => 400, 'message' => $toastData]);
            ...
            if ($result != 'ok') {
               // return $result;
                return response(['statusCode' => 400, 'message' => "Already added ",'data'=>$result]);
            }
            }
        } 
        ...
        $toastData = [
         ...
         return response(['statusCode' => 200, 'message' => $toastData]);
       // return back()->with(['toast' => $toastData]);
    }
