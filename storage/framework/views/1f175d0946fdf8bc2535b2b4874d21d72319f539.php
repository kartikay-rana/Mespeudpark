                ...
                <?php if($heroSection == "2"): ?>
                    ...
                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                        <div class="col-12 col-md-7 col-lg-6">
                          ...
                          <a href="#"><button class="mydemobutton">Click Here for Free Demo Class</button></a>
                        ...
                        <div class="position-relative ">
                            ...
                            <div class="example-instructor-card bg-white rounded-sm shadow-lg  p-5 p-md-15 d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ml-15">
                                    <span class="font-14 font-weight-bold text-secondary d-block">Download Now</span>
                                    <span class="text-gray font-12 font-weight-500">and get the best offers</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>