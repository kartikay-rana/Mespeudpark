                        ...
                        @if($course->isWebinar())
                            ...
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ml-5 font-14 font-weight-500"><!--{{ trans('public.capacity') }}-->Batch Strength:</span>
                                </div>
                        ...
                        @if(!empty($course->access_days))
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ml-5 font-14 font-weight-500"><!--{{ trans('update.access_period') }}-->Duration of Course:</span>
                                </div>
