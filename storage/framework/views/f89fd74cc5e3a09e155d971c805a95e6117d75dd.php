                        ...
                        <?php if($course->isWebinar()): ?>
                            ...
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ml-5 font-14 font-weight-500"><!--<?php echo e(trans('public.capacity')); ?>-->Batch Strength:</span>
                                </div>
                        ...
                        <?php if(!empty($course->access_days)): ?>
                            <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="ml-5 font-14 font-weight-500"><!--<?php echo e(trans('update.access_period')); ?>-->Duration of Course:</span>
                                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/web/default/course/index.blade.php ENDPATH**/ ?>