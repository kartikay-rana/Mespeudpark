...
class WebinarController extends Controller
{
    ...
    public function create()
    {
        ...
        $course_type = DB::table('course_type')->where('status',1)->get();
    ...
    { //dd($request->all());
        ...
        $this->validate($request, [
            // 'type' => 'required|in:webinar,course,text_lesson,study,test,crashcourse,recorded,previousyearpaper,currentaffairs',
            'type'=>'required',
