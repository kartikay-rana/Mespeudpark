                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="{{ old('negative_mark') }}" name="negative_mark" class="form-control @error('negative_mark')  is-invalid @enderror" placeholder=""/>
                                                @error('negative_mark')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="q_type">
                                                    ...
                                                    <option value="{{'p_y_q'}}">Priveris Year Question</option>
                                                    <option value="{{'c_a_q'}}">Current affair Question</option>
                                                </select>
                                                @error('q_type')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" value="{{ old('quiz_pdf') }}" name="quiz_pdf" class="form-control @error('quiz_pdf')  is-invalid @enderror" placeholder=""/>
                                                @error('quiz_pdf')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
