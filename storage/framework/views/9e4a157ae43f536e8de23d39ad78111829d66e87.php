                ...
                <li class="nav-item dropdown <?php echo e((request()->is('admin/webinars*') and !request()->is('admin/webinars/comments*')) ? 'active' : ''); ?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_webinars_list')): ?>
                            ...
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'study') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['studys']) and $sidebarBeeps['studys']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=study"><?php echo e('Study'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'test') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['tests']) and $sidebarBeeps['tests']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=test"><?php echo e('Test'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'crashcourse') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['crashcourses']) and $sidebarBeeps['crashcourses']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=crashcourse"><?php echo e('Crashcourses'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'recorded') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['recordeds']) and $sidebarBeeps['recordeds']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=recorded"><?php echo e('Recorded'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'previousyearpaper') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['previousyearpapers']) and $sidebarBeeps['previousyearpapers']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=previousyearpaper"><?php echo e('Previous year papers'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'currentaffairs') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['currentaffairs']) and $sidebarBeeps['currentaffairs']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=currentaffairs"><?php echo e('Current Affairs'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'one_liner') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['one_liner']) and $sidebarBeeps['one_liner']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=one_liner"><?php echo e('One Line'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'job_alert_upcoming') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['job_alert_upcoming']) and $sidebarBeeps['job_alert_upcoming']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=job_alert_upcoming"><?php echo e('Job alert Upcoming'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'job_alert_latest') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['job_alert_latest']) and $sidebarBeeps['job_alert_latest']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=job_alert_latest"><?php echo e('Job alert Latest'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'legal_updates') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['legal_updates']) and $sidebarBeeps['legal_updates']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=legal_updates"><?php echo e('Legal Update'); ?></a>
                            </li>
                            <li class="<?php echo e((request()->is('admin/webinars') and request()->get('type') == 'section_time_test') ? 'active' : ''); ?>">
                                <a class="nav-link <?php if(!empty($sidebarBeeps['section_time_test']) and $sidebarBeeps['section_time_test']): ?> beep beep-sidebar <?php endif; ?>" href="/admin/webinars?type=section_time_test"><?php echo e('Section time set'); ?></a>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>