...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share']], function () {
   ...
   // return what you want
    ...
    Route::get('/migration_run', function () {
    ...
    Route::group(['prefix' => 'meetings'], function () {
        ...
        Route::get('/create_new', 'MeetingController@create_new')->name('create_new');
         ...
         Route::get('/getrecordinglist/{id}', 'MeetingController@getrecordinglist');
         
        Route::get('/manage_meeting', 'MeetingController@manage_meeting')->name('manage_meeting');
