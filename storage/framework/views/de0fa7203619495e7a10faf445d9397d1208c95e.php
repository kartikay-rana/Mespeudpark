        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/admin/quizzes/store" id="webinarForm" enctype="multipart/form-data" class="webinar-form">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" value="<?php echo e(old('negative_mark')); ?>" name="negative_mark" class="form-control <?php $__errorArgs = ['negative_mark'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="q_type">
                                                    ...
                                                    <option value="<?php echo e('p_y_q'); ?>">Priveris Year Question</option>
                                                    <option value="<?php echo e('c_a_q'); ?>">Current affair Question</option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" value="<?php echo e(old('quiz_pdf')); ?>" name="quiz_pdf" class="form-control <?php $__errorArgs = ['quiz_pdf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimpariksha/public_html/resources/views/admin/quizzes/create.blade.php ENDPATH**/ ?>