...
<?php if(!empty($learningMaterialsExtraDescription) and count($learningMaterialsExtraDescription)): ?>
    <div class="mt-20 rounded-sm border bg-info-light p-15">
        <h3 class="font-16 text-secondary font-weight-bold mb-15">
            <!--<?php echo e(trans('update.what_you_will_learn')); ?>-->
            What you will get ?
            </h3>
...
<?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/web/default/course/tabs/information.blade.php ENDPATH**/ ?>