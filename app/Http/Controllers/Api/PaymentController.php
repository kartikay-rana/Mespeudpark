...
class PaymentController extends Controller
{
    ...
    public function paymentVerify(Request $request)
    {
        ...
        try {
            ...
            $toastData = [
              ...
              return response(['statusCode' => 400, 'message' => "Payment status",'data'=>$toastData]);
    ...
    private function paymentOrderAfterVerify($order)
    {
        if (!empty($order)) {
            ...
            session()->put($this->order_session_key, $order->id);
      return response(['statusCode' => 200, 'message' => "Successful payment"]);
  ...
  return response(['statusCode' => 400, 'message' => "Payment status",'data'=>$data]);
