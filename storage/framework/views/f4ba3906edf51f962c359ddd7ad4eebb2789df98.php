...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <option value="study" <?php if((!empty($webinar) and $webinar->isStudy()) or old('type') == \App\Models\Webinar::$study): ?> selected <?php endif; ?>><?php echo e('Study'); ?></option>
                                                    <option value="test" <?php if((!empty($webinar) and $webinar->isTest()) or old('type') == \App\Models\Webinar::$test): ?> selected <?php endif; ?>><?php echo e('Test'); ?></option>
                                                    <option value="crashcourse" <?php if((!empty($webinar) and $webinar->isCrashcourse()) or old('type') == \App\Models\Webinar::$crashcourse): ?> selected <?php endif; ?>><?php echo e('Crash Course'); ?></option>
                                                    <option value="recorded" <?php if((!empty($webinar) and $webinar->isRecorded()) or old('type') == \App\Models\Webinar::$recorded): ?> selected <?php endif; ?>><?php echo e('Recorded Lectures'); ?></option>
                                                    <option value="previousyearpaper" <?php if((!empty($webinar) and $webinar->isPreviousyearpaper()) or old('type') == \App\Models\Webinar::$previousyearpaper): ?> selected <?php endif; ?>><?php echo e('Previous year paper'); ?></option>
                                                    <option value="currentaffairs" <?php if((!empty($webinar) and $webinar->isCurrentaffairs()) or old('type') == \App\Models\Webinar::$currentaffairs): ?> selected <?php endif; ?>><?php echo e('Current Affairs'); ?></option>
                                                    <option value="one_liner" <?php if((!empty($webinar) and $webinar->isOne_liner()) or old('type') == \App\Models\Webinar::$one_liner): ?> selected <?php endif; ?>><?php echo e('One Line'); ?></option>
                                                    <option value="job_alert_upcoming" <?php if((!empty($webinar) and $webinar->isJob_alert_upcoming()) or old('type') == \App\Models\Webinar::$job_alert_upcoming): ?> selected <?php endif; ?>><?php echo e('Job alert upcoming'); ?></option>
                                                    <option value="job_alert_latest" <?php if((!empty($webinar) and $webinar->isJob_alert_latest()) or old('type') == \App\Models\Webinar::$job_alert_latest): ?> selected <?php endif; ?>><?php echo e('job alert latest'); ?></option>
                                                    <option value="legal_updates" <?php if((!empty($webinar) and $webinar->isLegal_updates()) or old('type') == \App\Models\Webinar::$legal_updates): ?> selected <?php endif; ?>><?php echo e('Legal Update'); ?></option>
                                                    <option value="section_time_test" <?php if((!empty($webinar) and $webinar->isSection_time_test()) or old('type') == \App\Models\Webinar::$section_time_test): ?> selected <?php endif; ?>><?php echo e('Section time set'); ?></option>
                                                </select>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>