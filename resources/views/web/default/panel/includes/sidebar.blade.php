            ...
            <div class="collapse {{ (request()->is('panel/meetings') or request()->is('panel/meetings/*')) ? 'show' : '' }}" id="meetingCollapse">
                <ul class="sidenav-item-collapse">
                    ...
                    @if(Auth::user()->role_id==1)
                           ...
                           <li class="mt-5 {{ (request()->is('panel/meetings/manage_meeting')) ? 'active' : '' }}">
                            <a href="/panel/meetings/manage_meeting">Manage Meeting</a>
                        </li>
                        @endif
                    ...
                    @if($authUser->isOrganization() || $authUser->isTeacher())
                      ...
                      <li class="mt-5 {{ (request()->is('panel/meetings/create_new')) ? 'active' : '' }}">
                            <a href="/panel/meetings/create_new">Create New</a>
                        </li>
                           <li class="mt-5 {{ (request()->is('panel/meetings/manage_meeting')) ? 'active' : '' }}">
                            <a href="/panel/meetings/manage_meeting">Manage Meeting</a>
                        </li>
