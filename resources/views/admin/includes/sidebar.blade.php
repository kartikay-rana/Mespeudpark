                ...
                <li class="nav-item dropdown {{ (request()->is('admin/webinars*') and !request()->is('admin/webinars/comments*')) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            ...
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'study') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['studys']) and $sidebarBeeps['studys']) beep beep-sidebar @endif" href="/admin/webinars?type=study">{{ 'Study' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'test') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['tests']) and $sidebarBeeps['tests']) beep beep-sidebar @endif" href="/admin/webinars?type=test">{{ 'Test' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'crashcourse') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['crashcourses']) and $sidebarBeeps['crashcourses']) beep beep-sidebar @endif" href="/admin/webinars?type=crashcourse">{{ 'Crashcourses' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'recorded') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['recordeds']) and $sidebarBeeps['recordeds']) beep beep-sidebar @endif" href="/admin/webinars?type=recorded">{{ 'Recorded' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'previousyearpaper') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['previousyearpapers']) and $sidebarBeeps['previousyearpapers']) beep beep-sidebar @endif" href="/admin/webinars?type=previousyearpaper">{{ 'Previous year papers' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'currentaffairs') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['currentaffairs']) and $sidebarBeeps['currentaffairs']) beep beep-sidebar @endif" href="/admin/webinars?type=currentaffairs">{{ 'Current Affairs' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'one_liner') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['one_liner']) and $sidebarBeeps['one_liner']) beep beep-sidebar @endif" href="/admin/webinars?type=one_liner">{{ 'One Line' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'job_alert_upcoming') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['job_alert_upcoming']) and $sidebarBeeps['job_alert_upcoming']) beep beep-sidebar @endif" href="/admin/webinars?type=job_alert_upcoming">{{ 'Job alert Upcoming' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'job_alert_latest') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['job_alert_latest']) and $sidebarBeeps['job_alert_latest']) beep beep-sidebar @endif" href="/admin/webinars?type=job_alert_latest">{{ 'Job alert Latest' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'legal_updates') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['legal_updates']) and $sidebarBeeps['legal_updates']) beep beep-sidebar @endif" href="/admin/webinars?type=legal_updates">{{ 'Legal Update' }}</a>
                            </li>
                            <li class="{{ (request()->is('admin/webinars') and request()->get('type') == 'section_time_test') ? 'active' : '' }}">
                                <a class="nav-link @if(!empty($sidebarBeeps['section_time_test']) and $sidebarBeeps['section_time_test']) beep beep-sidebar @endif" href="/admin/webinars?type=section_time_test">{{ 'Section time set' }}</a>
                            </li>
                        @endcan()
