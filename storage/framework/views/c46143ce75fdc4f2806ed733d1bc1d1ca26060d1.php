<div class="dropdown">
    <button type="button" <?php echo e((empty($userCarts) or count($userCarts) < 1) ? 'disabled' : ''); ?> class="btn btn-transparent dropdown-toggle" id="navbarShopingCart" data-toggle="dropdown"
        ...
        <i data-feather="shopping-cart" width="20" height="20" class="mr-10"></i><span>Cart</span>
...
<?php /**PATH /home/u834781590/domains/mspedupark.com/public_html/resources/views/web/default/includes/shopping-cart-dropdwon.blade.php ENDPATH**/ ?>